...
create table
    public.autoevaluations (
                               ...
                               eval text not null default 'no evaluated'::text,
                               quizz_eval text not null default 'no evaluated'::text,
                               ...
                               constraint autoevaluations_eval_check1 check (
                                   (
                                       eval = any (
                                           array[
                                               'acquis'::text,
...
create table
    public.resources (
                         ...
                         constraint resources_id_module_fkey foreign key (id_module) references modules (id) on update cascade on delete cascade
);